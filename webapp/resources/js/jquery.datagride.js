/*** jQuery EasyUI 1.2.3* * Licensed under the GPL terms* To use it on other terms please contact us** Copyright(c) 2009-2011 stworthy [ stworthy@gmail.com ] * */
(function($) {
            ...
            if (typeof opts.toolbar == "string") {
                ...
                for (var i = 0; i < opts.toolbar.length; i++) {
                    ...
                    if (btn == "-") {
                        ...
                        lnkObj[0].onclick = eval(btn.handler ||
                        function() {});
                        lnkObj.css("float", "left").appendTo(tb).linkbutton($.extend({},
                        btn, {
                            plain: true
                        }));
                    }
    ...
    function bindRowEvents(target) {
        ...
        pnlBody.find("tr[datagrid-row-index]").unbind(".datagrid").bind("mouseenter.datagrid",
        function() {
        ...
        pnlBody.find("td[field]").unbind(".datagrid").bind("click.datagrid",
        function() {
        ...
        pnlBody.find("div.datagrid-cell-check input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function(e) {
    ...
    function bindCellsEvents(target) {
        ...
        pnlHeader.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind("mouseenter.datagrid",
        function() {
        ...
        pnlHeader.find("div.datagrid-cell").unbind(".datagrid").bind("click.datagrid",
        function() {
        ...
        pnlHeader.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function() {
            if (opts.singleSelect) {
                return false;
            }
        ...
        var view1 = view.children("div.datagrid-view1");
        var view2 = view.children("div.datagrid-view2");
        view2.children("div.datagrid-body").unbind(".datagrid").bind("scroll.datagrid",
        function() {
        ...
        pnlHeader.find("div.datagrid-cell").each(function() {
            $(this).resizable({
                ...
                onStartResize: function(e) {
                    view.children("div.datagrid-resize-proxy").css({
                        left: e.pageX - $(pnl).offset().left - 1,
                        display: "block"
                    });
                },
                onResize: function(e) {
        ...
        view1.children("div.datagrid-header").find("div.datagrid-cell").resizable({
            onStopResize: function(e) {
                var filed = $(this).parent().attr("field");
    ...
    function selectRow(target, index) {
        ...
        if (!tr.hasClass("datagrid-row-selected")) {
            ...
            if (opts.idField) {
                var row = data.rows[index]; (function() {
                    for (var i = 0; i < selectRows.length; i++) {
                        if (selectRows[i][opts.idField] == row[opts.idField]) {
                            return;
                        }
            ...
            if (col && col.editor) {
                ...
                if (tmpEditor) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: tmpEditor,
                        target: tmpEditor.init(cell.find("td"), tmpOpts),
                        field: thisFiled,
                        type: tmpType,
                        oldHtml: cellHtml
                    });
    ...
    $.fn.datagrid = function(options, param) {
        ...
        return this.each(function() {
            ...
            if (state) {
                ...
                opts = $.extend({},
                $.fn.datagrid.defaults, $.fn.datagrid.parseOptions(this), options);
