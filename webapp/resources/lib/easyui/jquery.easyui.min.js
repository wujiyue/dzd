...
dc.body1.add(dc.body2).prepend("<table class=\"datagrid-btable datagrid-btable-frozen\" width=\"100%\" style=\"border:1px solid red;\" cellspacing=\"0\" cellpadding=\"0\"></table>");
}
_4dd(true);
_4dd(false);
_4bf(_4da);
...
//做combox下拉菜单时，如果点击的不是子节点，则不会隐藏选择面板combox必需有一sons属性  peiwenlong  
_85c(_857);
if(node.attributes!=undefined||node.attributes==null){
	if(node.attributes!=null){
		if(node.attributes.sons=='0'){
