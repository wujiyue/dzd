...
<%
	...
	String fjh=request.getParameter("fjh")==null?"":request.getParameter("fjh");
%>
...
<section>
 ...
 <!--  <div class="weui_panel">
       ...
       <h4 style="text-align:center;color:#9C0;font-size:20px;  margin:16px auto;">发票列表</h4>
       <!--  <a href="javascript:;" onclick="toIndex()" style="float:left;" class="weui_btn weui_btn_mini weui_btn_plain_primary">返回</a> -->
        ...
        <div class="weui_btn_area e-mt20">
            <a href="javascript:;" onclick="toIndex()" class="weui_btn weui_btn_warn " >返回</a>
        </div>
    </div>
    <!-- 发票列表end -->	
