    ...
    <div class="container-fluid">
        <form action="" id="form_show" method="post" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 formControls">
                    <%--<input type="text" id="timeline_type" name="timeline_type" placeholder="记录类型" value="${timeline.timeline_type}" class="form-control" datatype="*" nullmsg="请输入记录类型" />--%>
