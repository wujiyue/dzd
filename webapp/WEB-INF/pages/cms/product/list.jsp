...
<!--面包屑导航条-->
<nav class="breadcrumb"><i class="fa fa-home"></i> 首页 <span class="c-gray en">&gt;</span> CMS <span class="c-gray en">&gt;</span>产品管理</nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="cpdm" name="cpdm"  placeholder="产品代码" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="cpmc" name="cpmc"  placeholder="产品名称" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">注册方式：</label>
                            <div class="col-sm-9">
                                <input type="text" id="zcfs" name="zcfs"  placeholder="注册方式" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">注册密钥：</label>
                            <div class="col-sm-9">
                                <input type="text" id="zcmy" name="zcmy"  placeholder="注册密钥" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label   class="col-sm-3 control-label">产品描述：</label>
                            <div class="col-sm-9">
                                <textarea id="cpsm" name="cpsm" rows="3" style="width: 100%" class="form-control"  placeholder="描述"></textarea>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" >
    ...
    $(function(){
        ...
        $(document).ajaxError(
                ...
                function(event,xhr,options,exc ){
                    ...
                    switch(xhr.status){
                        case 200:
                            alert("登录信息失效，请重新登录系统。");
                            alert(xhr.responseText);
                            top.window.location=sys_ctx+"/login";
                            return;
                        case 403:
                            // 未授权异常
                            alert("系统拒绝：您没有访问权限。");
    ...
    function sys_table_list(){
        ...
        table_list_Params.url='${ctx}/cms/product/json/find'+queryStr;
    ...
    var onClickRow=function(row,tr){
        ...
        $('#modal-form').on('show.bs.modal', function() {
            $('#modal-form .modal-header h3').html("编辑产品信息");
    ...
    function addNew(){
        ...
        $('#modal-form').on('show.bs.modal', function() {
            $('#modal-form .modal-header h3').html("新增产品信息");
            $('#form_show').bootstrapValidator('resetForm', true);
            $('#form_show')[0].reset();
            $('#id').val("");
        });
