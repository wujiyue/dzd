...
<div class="wrapper  animated fadeInRight">
  <div class="container-fluid">
    ...
    <input type="hidden" value="${sendEmail.id}" id="id" name="id"/>
		<h2 class="text-center">编辑邮件发送</h2>
  ...
  <input type="text" id="content" name="content" placeholder="内容" value="${sendEmail.content}" class="form-control" datatype="*" nullmsg="请输入内容" />
        ...
        <%--<div class="form-group">
              <label class="col-sm-2 control-label">是否反馈：</label>
               <div class="col-sm-6 formControls">
  <input type="text" id="feedback" name="feedback" placeholder="是否反馈" value="${sendEmail.feedback}" class="form-control" datatype="*" nullmsg="请输入是否反馈" />
              </div>
              <div class="col-sm-4">
              		<div class="Validform_checktip"></div>
              </div>
        ...
        <div class="form-group">
              <label class="col-sm-2 control-label">发送时间：</label>
               <div class="col-sm-6 formControls">
  <input type="text" id="sendTime" name="sendTime" placeholder="发送时间" value="${sendEmail.sendTime}" class="form-control" datatype="*" nullmsg="请输入发送时间" />
              </div>
              <div class="col-sm-4">
              		<div class="Validform_checktip"></div>
              </div>
