...
<div class="wrapper  animated fadeInRight">
  <div class="container-fluid">
    <form action="" id="form_show" method="post" class="form-horizontal" role="form">
		<h2 class="text-center">新增生成配置</h2>
         ...
         <div class="form-group">
              <label class="col-sm-3 control-label">说明：</label>
               <div class="col-sm-9">
                 <%-- <input type="text" id="description" name="description" placeholder="说明" value="${config.description}" class="form-control" />--%><%-- <input type="text" id="description" name="description" placeholder="说明" value="${config.description}" class="form-control" />--%><%-- <input type="text" id="description" name="description" placeholder="说明" value="${config.description}" class="form-control" />--%>
