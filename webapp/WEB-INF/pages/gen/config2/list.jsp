...
<!--面包屑导航条-->
<nav class="breadcrumb"><i class="fa fa-home"></i> 首页 <span class="c-gray en">&gt;</span> 代码生成 <span class="c-gray en">&gt;</span>代码生成配置管理</nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <%--<input type="text" id="section" name="section"  placeholder="类型" class="form-control">--%>
                                <bro:dicSelect id="section" value=""  ></bro:dicSelect>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">配置名称：</label>
                            <div class="col-sm-9">
                                <input type="text" id="name" name="name"  placeholder="配置名称" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">配置值：</label>
                            <div class="col-sm-9">
                                <input type="text" id="value" name="value"  placeholder="配置值" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label   class="col-sm-3 control-label">说明：</label>
                            <div class="col-sm-9">
                                <textarea id="description" name="description" rows="3" style="width: 100%" class="form-control"  placeholder="说明"></textarea>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" >
    ...
    function sys_table_list(){
        ...
        $('#tableList').bootstrapTable({
            ...
            url:'${ctx}/gen/config/json/find'+queryStr //服务器数据的加载地址
        });
    ...
    var onClickRow=function(row,tr){
        ...
        $('#modal-form').on('show.bs.modal', function() {
            $('#modal-form .modal-header h3').html("编辑生成配置");
            $('#form_show').bootstrapValidator('resetForm', true);
           $("#dicSelect_section").val(row["section"]);
    ...
    function addNew(){
        ...
        $('#modal-form').on('show.bs.modal', function() {
            $('#modal-form .modal-header h3').html("新增生成配置");
            $('#form_show').bootstrapValidator('resetForm', true);
            $('#form_show')[0].reset();
            $('#id').val("");
        });
