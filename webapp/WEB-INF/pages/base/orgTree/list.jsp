...
<body class="gray-bg">
<!--面包屑导航条-->
<nav class="breadcrumb"><i class="fa fa-home"></i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 组织目录管理</nav>
...
<script type="text/javascript" >
   ...
   /* var tmp_parentid=0;
    ...
    var onClickRow=function(row,tr){
        layer_show("编辑部门",sys_ctx+"/org/department/edit?id="+row.id,'','','',function(){sys_table_list_bm();});
    }
    function addNew(){
        var params="?parentid="+tmp_parentid+"&parentname="+tmp_parentname;
        layer_show("新增部门",sys_ctx+"/org/department/add"+params,'','','',function(){sys_table_list_bm();refreshTree();});
    }
