         ...
         <div class="layui-form-item">
             ...
             <div class="layui-input-block">
                 <div class="layui-inline formControls">
                     <input type="text" id="account"   name="account" datatype="s2-12" nullmsg="请输入帐户名" autocomplete="off" placeholder="请输入用户账户" class="layui-input">
                 </div>
             ...
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                   <div class="layui-inline  formControls">
                       <input type="text" id="password" name="password" datatype="*6-12" nullmsg="请输入密码" autocomplete="off" placeholder="请输入用户密码" class="layui-input">
                   </div>
                   <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             ...
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <div class="layui-inline formControls">
                         <input type="text" id="usertype" name="usertype"  autocomplete="off" datatype="*"  placeholder="请输入用户类型" class="layui-input">
                    </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             ...
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <div class="layui-inline formControls">
                         <input type="text" id="nickname" name="nickname"   autocomplete="off" placeholder="请输入昵称" datatype="*2-12"  nullmsg="请输入昵称" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                </div>
             </div>
             ...
             <div class="layui-form-item">
                ...
                <div class="layui-input-block" >
                     <div class="layui-inline formControls">
                         <input type="text" name="birthday" id="birthday" ignore="ignore"  autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
                     </div>
                    <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block" >
                     <div class="layui-inline formControls">
                         <input type="number" name="age"  value="18" ignore="ignore"  autocomplete="off" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <div class="layui-inline formControls">
                        <input type="text" id="realname" name="realname" autocomplete="off" datatype="zh2-4"  ignore="ignore" placeholder="请输入真实姓名" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <div class="layui-inline formControls">
                         <input type="text" id="idcard" name="idcard"  ignore="ignore" datatype="idCard"   autocomplete="off" placeholder="请输入身份证" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
          ...
          <div class="layui-form-item">
            <label class="layui-form-label">故乡：</label>
             <div class="layui-input-block">
              ...
              <div id="hometown_div">  <input id="hometown" name="hometown" type="hidden" datatype="*"   value="${value}"/>
              </div>
              </div>
                  <div class="layui-inline"><div class="Validform_checktip"></div></div>
             ...
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     ...
                     <%--<input type="text" id="address" name="address" style="width: 80%;" ignore="ignore"   autocomplete="off" placeholder="请输入详细地址" class="layui-input">--%>
                         <textarea placeholder="请输入详细地址" id="address" name="address" datatype="s5-50" ignore="ignore"  class="layui-textarea"></textarea>
             ...
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <div class="layui-inline formControls">
                     <input type="text" id="qq" name="qq" datatype="qq" ignore="ignore" errormsg="qq格式不正确" autocomplete="off" placeholder="请输入QQ" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             ...
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <div class="layui-inline formControls">
                         <input type="text" id="email" name="email" datatype="e" errormsg="邮箱格式不正确"  ignore="ignore"  placeholder="请输入邮箱" autocomplete="off" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block ">
                     <input type="checkbox" checked="" id="emailflag"  name="emailflag" lay-skin="switch"  title="邮箱验证">
                 </div>
                 </div>
             </div>
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block ">
                     <div class="layui-inline formControls">
                         <input type="text" id="phone" name="phone" datatype="m" errormsg="手机格式不正确"  ignore="ignore"   placeholder="请输入手机" autocomplete="off" class="layui-input">
                     </div>
                     <div class="layui-inline"><div class="Validform_checktip"></div></div>
                 </div>
             </div>
             <div class="layui-form-item">
                 ...
                 <div class="layui-input-block">
                     <input type="checkbox" checked="" id="phoneflag"  name="phoneflag" lay-skin="switch"   title="phone验证">
                 </div>
                 </div>
             </div>
