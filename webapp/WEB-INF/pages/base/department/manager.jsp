  ...
  <script type="text/javascript">
   ...
   var tmp_parentname='';
    ...
    var click_table_line = function(guid){
      $.ajax({
        type:"post",
        url:'${ctx}/org/department/json/get/'+guid,
        data:null,
   ...
   var sortMenu = function(){
     /*sys_ajaxPost("/base/menu/default.do?method=sort",{qxid:tmp_qxid},function(json){
       var rows = json.rows;
       var str = "";
       for(var i=0;i<rows.length;i++){
         str += '<li class="ui-state-default" id="xh_'+rows[i]['qxid']+'"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>'+rows[i]['mc']+'</li>';
       };
        ...
        <form id="form_show">
          ...
          <table  class="c_table_show" border="0" cellpadding="0">
            ...
            <tr>
              ...
              <td>
                <input type="hidden" class="input-text" id="parentid" name="parentid" datatype="*" />
                <input type="text" class="input-text disabled" id="parentname" readonly name="parentname" />
                <div class="Validform_checktip"></div>
              </td>

            <tr>
              <td class="c_form_text" width="20%"><span style='color:red;'>*</span>部门名称</td>
              <td>
                <input type="text" class="input-text" nullmsg="请输入部门名称" id="name" name="name" datatype="*" />
                <div class="Validform_checktip"></div>
              </td>

            <tr>
              <td class="c_form_text" width="20%">电话</td>
              <td>
                <input type="text" class="input-text" id="phone" name="phone" />
                <div class="Validform_checktip"></div>
              </td>
            <tr>
              <td class="c_form_text" width="20%">传真</td>
              <td>
                <input type="text" class="input-text" id="fax" name="fax" />
                <div class="Validform_checktip"></div>
              </td>
            <tr>
              <td class="c_form_text" width="20%">邮箱</td>
              <td>
