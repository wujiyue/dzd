...
<article class="page-container" >
  <div class="form form-horizontal responsive">
    <form action="" id="form_show" method="post">
      <div class="row cl">
			<label class="form-label col-2"><span style='color:red;'>*</span>安全问题:</label>
		 <div class="formControls col-3">
			<input type="text" class="input-text" name="question" datatype="*" value="${securityQueston.question}" />
		</div>
		<div>
