    ...
    <div class="cl">
        <form id="form_query" style="margin-bottom: 15px">
            <div class="menu-bar-default">
                ...
                <%-- <a data-toggle="modal" class="btn btn-sm btn-primary" href="#modal-form"><i class="fa fa-plus"></i>&nbsp;新增</a>--%>
                ...
                <div class="modal-body">
                        ...
                        <input type="hidden" id="id" name="id">
                                ...
                                <div class="form-group">
                                   ...
                                   <%-- <input type="text" id="csz" name="csz"  placeholder="请输入参数代码" class="form-control">--%>
                                    <div class="col-sm-9">
...
<script type="text/javascript" >
    ...
    function sys_table_list(){
        ...
        $('#tableList').bootstrapTable({
            ...
            url:'${ctx}/base/para/json/find'+queryStr //服务器数据的加载地址
        });
