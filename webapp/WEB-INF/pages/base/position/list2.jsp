    ...
    var query = function(formid){
     ...
     var sys_table_list = function(){
          var columns = [[
			...
			{field:'orgid',title:'机构组织id',align:'center',width:table_list_td_width},
			...
			{field:'name',title:'岗位名称',align:'center',width:table_list_td_width},
			{field:'description',title:'岗位描述',align:'center',width:table_list_td_width},
          ...
          table_list_dataGrid.url = sys_ctx+'/org/position/json/find';
     ...
     var click_table_line = function(guid){
           $.ajax({
             type:"post",
             url:'${ctx}/org/position/json/get/'+guid,
             data:null,
     ...
     function save(){
          ...
          if(!b){
           ...
           $.ajax({
             type:"post",
             url:'${ctx}/org/position/json/save?'+params,
             data:null,
             success:function(json,textStatus){
     ...
     function list_del(tableid){
           ...
           if(selecRow.length > 0){
             layer.confirm("确定这样做吗？", {
               ...
               $.ajax({
                 type:"post",
                 url:'${ctx}/org/position/json/removes/'+ids,
                 data:null,
...
<body>
<!--面包屑导航条-->
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> base <span class="c-gray en">&gt;</span> 岗位管理<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
      ...
      <div id="div_show" title="详细信息" style="width:450px;height:270px;display: none;">
            ...
            <div class="c_div_show_content">
              <form id="form_show">
                ...
                <tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>机构组织id</td>
					<td>
				...
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>parentids</td>
					<td>
						<input type="text" class="input-text" id="parentids" name="parentids" datatype="*" />
						<div class="Validform_checktip"></div>
					</td>
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>岗位名称</td>
					<td>
						<input type="text" class="input-text" id="name" name="name" datatype="*" />
						<div class="Validform_checktip"></div>
					</td>
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>岗位描述</td>
					<td>
						<input type="text" class="input-text" id="description" name="description" datatype="*" />
						<div class="Validform_checktip"></div>
					</td>
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>排序</td>
					<td>
						<input type="text" class="input-text" id="sort" name="sort" datatype="*" />
						<div class="Validform_checktip"></div>
					</td>
