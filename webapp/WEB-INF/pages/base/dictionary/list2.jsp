    ...
    var query = function(formid){
     ...
     var sys_table_list = function(){
          var columns = [[
			...
			{field:'value',title:'值',align:'center',width:table_list_td_width},
			{field:'label',title:'内容',align:'center',width:table_list_td_width},
			{field:'description',title:'类型的描述',align:'center',width:table_list_td_width},
          ...
          table_list_dataGrid.url = sys_ctx+'/base/dictionary/json/find';
     ...
     var click_table_line = function(guid){
           $.ajax({
             type:"post",
             url:'${ctx}/base/dictionary/json/get/'+guid,
             data:null,
...
<body>
<!--面包屑导航条-->
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 数据字典管理<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
      ...
      <div id="div_show" title="详细信息" style="width:450px;height:270px;display: none;">
            ...
            <div class="c_div_show_content">
              <form id="form_show">
				...
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>值</td>
					<td>
						<input type="text" class="input-text" id="value" name="value" datatype="*" />
						<div class="Validform_checktip"></div>
					</td>
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>内容</td>
					<td>
						<input type="text" class="input-text" id="label" name="label" datatype="*" />
						<div class="Validform_checktip"></div>
					</td>
				<tr>
					<td class="c_form_text" width="20%"><span style='color:red;'>*</span>类型的描述</td>
					<td>
