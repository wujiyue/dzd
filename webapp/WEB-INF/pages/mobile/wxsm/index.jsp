...
<html>
  <head>
   ...
   <!--  <link rel="stylesheet" type="text/css" href="css/m.reset.css"> -->
    <link rel="stylesheet" type="text/css" href="/resources/mobile/wxsm/css/weui.css">
...
function config(){
	...
	$.ajax({
        async: false,
		type : "post",
		url : "http://150e8777c5.iok.la/cpzz/servlet/wxsm?targetUrl="+targetUrl,
		data : '',
		dataType : "json",
...
function  query(){
	...
	window.location.href=sys_ctx+"/zcpt/wxsm/list.jsp?fpdm="+fpdm+"&kprq_q="+kprq_q+"&kprq_z="+kprq_z;
}
$(function(){
