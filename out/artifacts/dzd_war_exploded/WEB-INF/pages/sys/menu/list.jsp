...
<div class="btn-group mt-10 cl">
    <div class="l">
        <a  onclick="add()"  id="bro_addBtn" class="btn btn-success radius">新增</a>
                                    ...
                                    success:function(data,textStatus){
                                        ...
                                        if(textStatus=='success'){
                                            if(data.type=='success'){
                                                ...
                                                parent.layer.msg(data.content, {icon: 5,time:2500});
                                            }
                                        }else{
                                            parent.layer.msg("批量删除失败！", {icon: 5,time:2500});
                                        }
                                    },
                                    error:ajaxError
                                });
