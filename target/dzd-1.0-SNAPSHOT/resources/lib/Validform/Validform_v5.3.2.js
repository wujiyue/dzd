...
(function($,win,undef){
	...
	var tipmsg={//默认提示文字;
		...
		w:{
			...
			"zh":"请填写中文！",
			"zh2-8":"请填写2-8位中文！",
			"u":"必须为字母开头，字母数字或者下划线的组合！",
			"u3-10":"必须为3-10位字母开头，字母数字或者下划线的组合！",
			"*6-16":"6到16位任意字符！",
			"n":"请填写数字！",
			"n6-16":"6到16位数字！",
			"s":"不能输入特殊字符！",
	...
	Validform.util={
		dataType:{
			...
			"zh":/^[\u4E00-\u9FA5\uf900-\ufa2d]$/,
			"zh2-8":/^[\u4E00-\u9FA5\uf900-\ufa2d]{2,8}$/,
			"u":/^[a-zA-z][a-zA-Z0-9_]$/,//用户名：必须字母开头，数字字母或者下划线组合
			"u3-10":/^[a-zA-z][a-zA-Z0-9_]{3,10}$/,//用户名：必须字母开头，数字字母或者下划线组合3到10位
			"*6-16":/^[\w\W]{6,16}$/,
			"n":/^\d+$/,
			"n6-16":/^\d{6,16}$/,
			"s":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]+$/,
