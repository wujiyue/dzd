...
//alert提示框
function common_showAlert(title,okCallBack){
	if(title==undefined||title==''||title==null||title=='undefined'){
		title='';
	}
	var html=
		'<div class="weui_dialog_alert" id="wjy-dialog" style="display: none;">'+
		'<div class="weui_mask"></div>'+
		' <div class="weui_dialog">'+
...
function common_showWarning(msg,timemills){
	if(timemills==undefined||timemills==null||timemills==''||timemills=="undefined"||timemills=='null'){
		timemills=1800;
	}
	var html="<div id=\"wjy-warning\" class=\"weui_toptips weui_warn js_tooltips\" style=\"display: none;\">格式不对</div>";
	$("#g-container").append(html);
	$('#wjy-warning').html(msg).show();
    setTimeout(function (){
        $('#wjy-warning').hide();
    }, timemills);
}
...
function common_showToastNew(msg){
	...
	html+="<p class=\"weui_toast_content\">已完成</p>";
	html+="</div></div>";
	$("#g-container").append(html);
