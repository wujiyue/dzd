...
<div class="wrapper  animated fadeInRight">
  <div class="container-fluid">
    <form action="" id="form_show" method="post" class="form-horizontal" role="form">
		<h2 class="text-center">新增产品更新日志</h2>

        <div class="form-group">
              <label class="col-sm-2 control-label">产品代码：</label>
               <div class="col-sm-6 formControls">
  <%--<input type="text" id="cpdm" name="cpdm" placeholder="产品代码" value="${cpupdateLog.cpdm}" class="form-control" datatype="*" nullmsg="请输入产品代码" />--%>
