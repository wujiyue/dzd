...
<script type="text/javascript" >
    ...
    function addNew(){
        layer_show("新增菜单权限",sys_ctx+"/sys/permission/add?parentid="+tmp_parentid+"&parentname="+tmp_parentname,'','',''
                ,function(){
                    sys_table_list();
                    refreshTree();
                });
    ...
    function sys_table_list(){
        ...
        $('#tableList').bootstrapTable({
            ...
            url:'${ctx}/sys/permission/json/find'+queryStr //服务器数据的加载地址
        });

    }

    var onClickRow=function(row,tr){
        layer_show("编辑菜单权限",sys_ctx+"/sys/permission/edit?id="+row.id,'','','',function(){sys_table_list();});
    }
    function addNew(){
        var params="?parentid="+tmp_parentid+"&parentname="+tmp_parentname;
        layer_show("新增菜单权限",sys_ctx+"/sys/permission/add"+params,'','','',function(){sys_table_list();refreshTree();});
    }
