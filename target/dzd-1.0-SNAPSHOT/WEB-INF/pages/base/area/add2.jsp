    ...
    <form action="" id="form_show" method="post">
		<div class="row cl">
			...
			<div class="formControls col-3">
				<input type="hidden" class="input-text" name="areatype" datatype="*" value="${areatype}" />
				<input type="text" class="input-text disabled" readonly name="areatypename"  value="${areatypename}" />
      ...
      <div class="row cl">
		 ...
		 <div class="formControls col-3">
			...
			<input type="text" class="input-text disabled" readonly  name="parentname"  value="${parentname}" />
		 </div>
		<div>
		...
		<div class="row cl">
		 ...
		 <div class="formControls col-3">
			<input type="text" class="input-text" name="code" datatype="*" nullmsg="请输入地区编码"/>
		</div>
		<div>
			<div class="Validform_checktip"></div>
		</div>
		...
		<div class="row cl">
		 ...
		 <div class="formControls col-3">
			<input type="text" class="input-text" name="name" datatype="*" nullmsg="请输入区域名称" />
		</div>
		<div>
			<div class="Validform_checktip"></div>
		</div>
