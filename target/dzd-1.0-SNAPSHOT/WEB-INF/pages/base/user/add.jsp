...
<div class="wrapper  animated fadeInRight">
  <div class="container-fluid">
    <form action="" id="form_show" method="post" class="form-horizontal" role="form">
		<h2 class="text-center">新增系统用户</h2>
         ...
         <div class="form-group">
              <label class="col-sm-3 control-label">用户账户：</label>
               <div class="col-sm-9">
                  <input type="text" id="account" name="account" placeholder="用户账户" class="form-control" />
               </div>
         </div>
         <div class="form-group">
              <label class="col-sm-3 control-label">用户密码：</label>
               <div class="col-sm-9">
                  <input type="text" id="password" name="password" placeholder="用户密码" class="form-control" />
               </div>
         </div>
         <div class="form-group">
              <label class="col-sm-3 control-label">用户类型：</label>
               <div class="col-sm-9">
                  <input type="text" id="usertype" name="usertype" placeholder="用户类型" class="form-control" />
               </div>
         </div>
         <div class="form-group">
              <label class="col-sm-3 control-label">昵称：</label>
               <div class="col-sm-9">
                  <input type="text" id="nickname" name="nickname" placeholder="昵称" class="form-control" />
               </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
              <label class="col-sm-3 control-label">性别：</label>
               <div class="col-sm-9">
                  <input type="text" id="gender" name="gender" placeholder="性别" class="form-control" />
               </div>
         </div>
         <div class="form-group">
              <label class="col-sm-3 control-label">生日：</label>
               <div class="col-sm-9">
                  <input type="text" id="birthday" name="birthday" placeholder="生日" class="form-control" />
               </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
              <label class="col-sm-3 control-label">身份证ID：</label>
               <div class="col-sm-9">
                  <input type="text" id="idcard" name="idcard" placeholder="身份证ID" class="form-control" />
               </div>
         </div>
         <div class="form-group">
              <label class="col-sm-3 control-label">故乡：</label>
               <div class="col-sm-9">
                  <input type="text" id="hometown" name="hometown" placeholder="故乡" class="form-control" />
               </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
              <label class="col-sm-3 control-label">email验证标志：</label>
               <div class="col-sm-9">
                  <input type="text" id="emailflag" name="emailflag" placeholder="email验证标志" class="form-control" />
               </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
              <label class="col-sm-3 control-label">phone验证标志：</label>
               <div class="col-sm-9">
                  <input type="text" id="phoneflag" name="phoneflag" placeholder="phone验证标志" class="form-control" />
               </div>
         </div>
        <%-- <div class="form-group">
