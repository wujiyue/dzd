  ...
  <div class="container-fluid">
    <form action="" id="form_show" method="post" class="form-horizontal" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <textarea rows="3" style="height: 70px;" class="form-control"  placeholder="" id="description" name="description">${role.description}</textarea>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  function save(){
    ...
    if(!b)
    {
      layerMsg_wrongIcon("表单校验不通过！",null);
      return;
    }
