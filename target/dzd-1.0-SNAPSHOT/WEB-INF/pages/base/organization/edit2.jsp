...
<article class="page-container" >
	<div class="form form-horizontal responsive">
		<form action="" id="form_show" method="post">
			...
			<div class="row cl">
				<label class="form-label col-2"><span style='color:red;'>*</span>机构名称:</label>
				<div class="formControls col-3">
					<input type="text" class="input-text" name="name" datatype="*" value="${organization.name}" />
				</div>
				<div>
			...
			<div class="row cl">
				...
				<div class="formControls col-3">
					<input type="text" class="input-text" name="phone"  value="${organization.phone}" />
				</div>
				<div>
					<div class="Validform_checktip"></div>
				</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-3">
					<input type="text" class="input-text" name="fax"  value="${organization.fax}" />
				</div>
				<div>
					<div class="Validform_checktip"></div>
				</div>
			...
			<div class="row cl">
				<label class="form-label col-2">机构描述:</label>
				<div class="formControls col-3">
